...
int main(void)
{
	...
	setar_parametros_PID(45, 15, 25, 100, 1, 30);								//Ajusta as constantes do PID para Roll e Pitch.

	//Qang, Qbiasmag, Racel, Rmag, Rorth
	setar_parametros_Kalman(5e-6, 5e-10, 0.5, 1.5, 1e-6);						//Ajusta as covariâncias do filtro de Kalman.
